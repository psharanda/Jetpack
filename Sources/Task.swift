...
extension Task {
     ...
     */
    public init(workerQueue: DispatchQueue, completionQueue: DispatchQueue = .main, worker: @escaping () -> TaskResult<ValueType>) {
    ...
    public init(workerQueue: DispatchQueue, completionQueue: DispatchQueue = .main, worker: @escaping () -> ValueType) {
        self.init(workerQueue: workerQueue, completionQueue: completionQueue) { () -> TaskResult<ValueType> in
     ...
     */
    public static func from(result: TaskResult<ValueType>) -> Task<ValueType> {
     ...
     */
    public static func from(value: ValueType) -> Task<ValueType> {
     ...
     */
    public static func from(error: Error) -> Task<ValueType> {
     ...
     */
    public static var cancelled: Task<ValueType> {
     ...
     */
    public static var never: Task<ValueType> {
        return Task<ValueType> { completion in
            return EmptyDisposable()
        }
    }
