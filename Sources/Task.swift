...
extension Task {
     ...
     */
    public init<U>(workerQueue: DispatchQueue, completionQueue: DispatchQueue = .main, worker: @escaping () -> Result<U>) where T == Result<U> {
     ...
     */
    public init<U>(workerQueue: DispatchQueue, completionQueue: DispatchQueue = .main, worker: @escaping () -> U)  where T == Result<U> {
     ...
     */
    public static func from<U>(result: Result<U>) -> Task<U>  where T == Result<U> {
